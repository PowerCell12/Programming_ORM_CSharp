    ...
    public class StartUp
    {
        ...
        public static Mapper Mapper(){
            var map = new MapperConfiguration(cfg => {
                ...
                cfg.CreateMap<Car, ExportCarMake>();
            });
        ...
        public static string GetCarsFromMakeBmw(CarDealerContext context){
            ...
            .ProjectTo<ExportCarMake>(Mapper().ConfigurationProvider).ToArray();

            var serializer = new XmlSerializer(typeof(ExportCarMake[]), new XmlRootAttribute("cars"));
