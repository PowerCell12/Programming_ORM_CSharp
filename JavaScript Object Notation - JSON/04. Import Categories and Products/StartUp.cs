...
namespace ProductShop
{
    public class StartUp
    {
        ...
        public static string ImportCategoryProducts(ProductShopContext context, string inputJson){
            ...
            var cat_pr = JsonConvert.DeserializeObject<List<CategoryProduct>>(inputJson);

            if (cat_pr != null){
                context.CategoriesProducts.AddRange(cat_pr);
                context.SaveChanges();
            }


            return $"Successfully imported {cat_pr?.Count}";;
