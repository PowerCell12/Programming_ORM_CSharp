...
public class StartUp{
    ...
    public static string DeleteProjectById(SoftUniContext context){
     ...
     public static string RemoveTown(SoftUniContext context){
        ...
        var town = context.Towns.Where(x => x.Name == "Seattle").First();

        var addresses = context.Addresses.Include(x => x.Employees).Include(x => x.Town).Where(x => x.Town.Name == "Seattle");
        ...
        int addresses_count = addresses.Count();
        ...
        return $"{addresses_count} addresses in Seattle were deleted";
