...
public class Program{
    public static void Main(string[] args){
        ...
        Console.WriteLine(StartUp.GetAddressesByTown(context)) ;
    }
}
}
...
public class StartUp{
    ...
    public static string GetEmployeesInPeriod(SoftUniContext context){ // fix ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

        var employees = context.Employees.Include(em => em.Manager).Take(10);
        List<string> final = new List<string>();
    ...
    public static string GetAddressesByTown(SoftUniContext context){
        ...
        var addresses = context.Addresses.Include(a => a.Employees).Include(a => a.Town).OrderByDescending(a => a.Employees.Count()).ThenBy(a => a.Town.Name).ThenBy(a => a.AddressText).Take(10);
